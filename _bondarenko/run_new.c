...
int rhs(double t, double *y, double *ydot, void *data, double *output) {
...
int run(double *S, double *A, double *C, int n_beats, double t_sampling, double tol,
        double *output, double *output_A) {
